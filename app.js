/* Desarrollado por: Sebastian Moreno */
...
function sortearAmigo(){
    ...
    resultado.innerHTML = `Tu amigo secreto es: ${amigoSorteado}, no se lo digas a nadie 🤫`; /* Con el método .innerHTML mostramos el nombre del amigo sorteado */
